...
//                        $("#uploadInf").append("<p>上传成功，文件地址是：" + response + "</p>");
                        ...
                        //从sessionStorage 新增数据
                        var imageid_ids = sessionStorage.getItem("imageid_ids"); 
                        console.log("1--"+imageid_ids);
                        
                        imageid_ids += ","+response;
                        
                        sessionStorage.setItem("imageid_ids", imageid_ids);
                        
                        console.log("2--"+imageid_ids);
                        
                        $("#imageid_ids").val(imageid_ids);
