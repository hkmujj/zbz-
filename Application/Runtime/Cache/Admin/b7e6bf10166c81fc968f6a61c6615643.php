...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo ($resource_path); ?>/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b style='color:#990000'>珍宝斋</b>管理后台</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">珍宝斋--成为弘扬文化艺术产业领航企业 </p>

    <form action="/index.php/Admin/Users/login.html" method="post">
...
<!-- iCheck -->
<script src="<?php echo ($resource_path); ?>/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
