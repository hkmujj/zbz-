...
<section>
    <div class="wrap">
        <div style="width: 100%;height: 390px;background: #fff;margin: 0 0 70px 0 "><img class="wrap_img"  src="<?php echo ($result['thumb']); ?>" /></div>
        <div class="about_we">
            <div class="nav">
                <ul>
                    <li><a href="<?php echo U('profile');?>">公司简介</a><span></span></li>
                    <li><a href="<?php echo U('honor');?>">荣誉资质</a><span ></span></li>
                    <li><a href="javascript:(0)" class="active_i">专家及艺术家团队</a><span class="active_im"></span></li>
                    <li><a href="<?php echo U('patent');?>">专利证书</a><span></span></li>
                    <li><a href="<?php echo U('history');?>">发展历程</a><span></span></li>
                </ul>
            </div>
